    ...
    <div class="content">
      <div class="row">
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 m-b-3">
          <div class="card">
            <div class="card-body">
              <div class="m-b-1"><i class="icon-facebook f-30 text-blue"></i>
        ...
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 m-b-3">
          <div class="card">
            <div class="card-body">
              <div class="m-b-1"><i class="icon-twitter f-30 text-blue"></i>
                <span class="pull-right text-muted">Tweets</span></div>
              <div class="info-widget-text row">
        ...
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 m-b-3">
          <div class="card">
            <div class="card-body">
              <div class="m-b-1"><i class="icon-googleplus f-30 text-blue"></i>
                <span class="pull-right text-muted">Share</span></div>
              <div class="info-widget-text row">
        ...
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 m-b-3">
          <div class="card">
            <div class="card-body">
              <div class="m-b-1"><i class="icon-rss f-30 text-blue"></i>
                <span class="pull-right text-muted">Posts</span></div>
              <div class="info-widget-text row">
        ...
        <div class="col-xl-8">
          <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Recent Sales <a class="btn btn-sm btn-primary pull-right text-white">View all</a>
              </h5>
            </div>
            <div class="table-responsive">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-outline-danger btn-rounded">Mobile</button>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-outline-success btn-rounded">Tablet</button>
                  </td>
                  <td>
                    <div class="progress progress-sm">
        ...
        <div class="col-lg-4 m-b-3">
          <div class="box box-widget widget-user-2">
            <div class="widget-user-header bg-yellow">
              <div class="widget-user-image"><img class="img-circle" src="{{url('')}}/img/img5.jpg" alt="User Avatar">
              </div>
