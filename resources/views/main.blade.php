...
<div class="wrapper boxed-wrapper">
  <header class="main-header">
    ...
    <span class="logo-lg"><img src="{{url('')}}/img/logo-blue.png" alt=""></span> </a>
    <!-- Header Navbar -->
    <nav class="navbar blue-bg navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-envelope-o"></i>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <ul class="menu">
                  <li><a href="#">
                    <div class="pull-left"><img src="{{url('')}}/img/img1.jpg" class="img-circle" alt="User Image"> <span class="profile-status online pull-right"></span></div>
                    <h4>Alex C. Patton</h4>
                    <p>I've finished it! See you so...</p>
                    <p><span class="time">9:30 AM</span></p>
                    </a></li>
                  <li><a href="#">
                    <div class="pull-left"><img src="{{url('')}}/img/img3.jpg" class="img-circle" alt="User Image"> <span class="profile-status offline pull-right"></span></div>
                    <h4>Nikolaj S. Henriksen</h4>
                    <p>I've finished it! See you so...</p>
                    <p><span class="time">10:15 AM</span></p>
                    </a></li>
                  <li><a href="#">
                    <div class="pull-left"><img src="{{url('')}}/img/img2.jpg" class="img-circle" alt="User Image"> <span class="profile-status away pull-right"></span></div>
                    <h4>Kasper S. Jessen</h4>
                    <p>I've finished it! See you so...</p>
                    <p><span class="time">8:45 AM</span></p>
                    </a></li>
                  <li><a href="#">
                    <div class="pull-left"><img src="{{url('')}}/img/img4.jpg" class="img-circle" alt="User Image"> <span class="profile-status busy pull-right"></span></div>
          ...
          <!-- User Account  -->
          <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="{{url('')}}/img/img1.jpg" class="user-image" alt="User Image"> <span class="hidden-xs">Alexander Pierce</span> </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                <div class="pull-left user-img"><img src="{{url('')}}/img/img1.jpg" class="img-responsive img-circle" alt="User"></div>
            ...
            <div class="table-responsive">
              <table class="table table-hover">
                ...
                <tbody>
                  <tr>
                    <td>iPone X</td>
                    <td><img src="{{url('')}}/img/img1.jpg" class="img-circle img-w-30" alt="User Image"></td>
                  ...
                  <tr>
                    <td>OPPP</td>
                    <td><img src="{{url('')}}/img/img2.jpg" class="img-circle img-w-30" alt="User Image"></td>
                  ...
                  <tr>
                    <td>iPad</td>
                    <td><img src="{{url('')}}/img/img3.jpg" class="img-circle img-w-30" alt="User Image"></td>
                    <td><button type="button" class="btn btn-sm btn-outline-danger btn-rounded">Mobile</button></td>
                    <td><div class="progress progress-sm">
        ...
        <div class="col-lg-4 m-b-3">
          <div class="box box-widget widget-user-2">
            <div class="widget-user-header bg-yellow">
              <div class="widget-user-image"> <img class="img-circle" src="{{url('')}}/img/img5.jpg" alt="User Avatar"> </div>
                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    <div class="direct-chat-msg">
                      ...
                      <img class="direct-chat-img" src="{{url('')}}/img/img2.jpg" alt="user image">
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <img class="direct-chat-img" src="{{url('')}}/img/img3.jpg" alt="user image">
                      <!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <img class="direct-chat-img" src="{{url('')}}/img/img4.jpg" alt="user image">
                      <div class="direct-chat-text"> A small river named Duden flows by their place and supplies it with the necessary. </div>
                    </div>
                    <div class="direct-chat-msg right">
                      ...
                      <img class="direct-chat-img" src="{{url('')}}/img/img5.jpg" alt="user image">
