...
<div class="wrapper boxed-wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <div class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"> <a href="{{ url('/home') }}"> <i class="icon-home"></i> <span>Dashboard</span> <span class="pull-right-container">  </a>
  ...
  <footer class="main-footer">
    ...
    Copyright © {{ date('Y')}} Yourdomian. All rights reserved.</footer>
</div>
<!-- ./wrapper -->
